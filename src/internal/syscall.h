...
#define __sys_open_cp2(x,pn,fl) __syscall_cp2(SYS_open, pn, fl)
#define __sys_open_cp3(x,pn,fl,mo) __syscall_cp3(SYS_open, pn, fl, mo)
#else
#define __sys_open2(x,pn,fl) __syscall3(SYS_openat, AT_FDCWD, pn, fl)
#define __sys_open3(x,pn,fl,mo) __syscall4(SYS_openat, AT_FDCWD, pn, fl, mo)
#define __sys_open_cp2(x,pn,fl) __syscall_cp3(SYS_openat, AT_FDCWD, pn, fl)
#define __sys_open_cp3(x,pn,fl,mo) __syscall_cp4(SYS_openat, AT_FDCWD, pn, fl, mo)
#endif
